var DEBUG=true;
      ...
      function initialize() {
        ...
        if (DEBUG) { bkg.console.log('spotA'+loginButton) };  
        loginButton.addEventListener('mousedown', function () {
          gdocs.login();
        });

        if (DEBUG) { bkg.console.log('spotB') };  
        ...
        if (DEBUG) { bkg.console.log('spotC') };  
        ...
        if (gdocs.isLoggedIn()) {
          if (DEBUG) { bkg.console.log('spotD') };  
	  ...
	  // Create open all docs in new window link
          ...
          if (DEBUG) { bkg.console.log('spotE--Logging in') };  
